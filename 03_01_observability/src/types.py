...
"""
### Description:
Shared data types for the 03_01_observability module.

Covers messages, tool calls, usage, completion params/results,
error codes, adapters, sessions, and agent run types — mirrors
src/types.ts from the JavaScript source.
...
# OpenAI Chat Completions message format — dict representation
...
class CompletionResult:
    """Successful result of an LLM completion call."""
