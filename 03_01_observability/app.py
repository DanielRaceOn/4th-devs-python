...
"""
### Description:
Entry point for the 03_01_observability module — mirrors src/index.ts.
...
Start-up sequence:
  ...
  4. Build adapter resolver (OpenAI Chat Completions)
...
# Load module-level .env first (overrides root .env for Langfuse keys, PORT)
...
_logger = create_logger({"service": "03_01_observability"})
...
async def main() -> None:
    ...
    _logger.info("starting 03_01_observability")
